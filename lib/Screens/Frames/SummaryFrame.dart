            ...
            child: Column(
              ...
              children: <Widget>[
                Row(
                  ...
                  children: <Widget>[
                    durationCard(
                        "${twoDigits(appModel.booking.tripDuration.inHours)}:${twoDigits(appModel.booking.tripDuration.inMinutes.remainder(60))}:${twoDigits(appModel.booking.tripDuration.inSeconds.remainder(60))}",
                        UniqueKey()),
